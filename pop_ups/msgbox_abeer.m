function varargout=msgbox_abeer(varargin)
%MSGBOX Message box.
...
inputStr = varargin{1};
BodyTextString = dialogCellstrHelper22(inputStr);
...
OKXOffset=(FigWidth-OKWidth)/2;
DefFigPos(3:4)=[FigWidth FigHeight];
DefFigPos = getnicedialoglocation22(DefFigPos, get(figureHandle,'Units'));
